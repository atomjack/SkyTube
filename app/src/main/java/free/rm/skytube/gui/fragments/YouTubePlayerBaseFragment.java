...
public abstract class YouTubePlayerBaseFragment extends ImmersiveModeFragment {
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		if((videoList.get(currentVideoIndex) != null && !videoList.get(currentVideoIndex).isDownloaded()) && (SkyTubeApp.isConnectedToWiFi() || (SkyTubeApp.isConnectedToMobile() && allowDownloadsOnMobile))) {
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		...
		if (videoList.get(currentVideoIndex) != null)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		switch (item.getItemId()) {
			...
			case R.id.block_channel:
				videoList.get(currentVideoIndex).blockChannel(getContext());
