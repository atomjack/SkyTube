...
public class ChromecastControllerFragment extends ChromecastBaseControllerFragment implements SeekBar.OnSeekBarChangeListener {
	...
	private void setupDescription() {
		if(video == null)
			return;
		videoDescriptionLayout.videoDescription.setText(video.getDescription());
...
//				YouTubePlayerFragment.this.youTubeChannel = youTubeChannel;
				...
				videoDescriptionLayout.subscribeButton.setOnClickListener(new View.OnClickListener() {
					@Override
					public void onClick(View view) {
						new SubscribeToChannelTask(videoDescriptionLayout.subscribeButton, youTubeChannel).execute();
					}
				});
